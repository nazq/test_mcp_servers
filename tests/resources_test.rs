...
fn test_resource_handler_read_dynamic_counter() {
    let handler = ResourceHandler::new();
    let request = ReadResourceRequestParams::new("test://dynamic/counter".to_string());
...
fn test_resource_handler_read_template() {
    let handler = ResourceHandler::new();
    let request = ReadResourceRequestParams::new("test://files/example.txt".to_string());
    let result = handler.read_resource(&request).unwrap();
...
fn test_resource_handler_read_unknown() {
    let handler = ResourceHandler::new();
    let request = ReadResourceRequestParams::new("test://nonexistent".to_string());
